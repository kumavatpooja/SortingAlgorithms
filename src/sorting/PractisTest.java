 ...
 * @author home
 */
public class PractisTest extends javax.swing.JFrame {
    // Create global variable for test answered and total.this variables must include in every jframe class
    ...
    private PractisTest(int i, int i0) {
    ...
    private void btnCheckanswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckanswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           if (jrbtn3.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is sinking sort");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           new PractisTest2(testanswered,marks).setVisible(true);
           this.dispose();
    ...
    public static void main(String args[]) {
        // this is the main class and project start from this class
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PractisTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PractisTest(0,0).setVisible(true);
            }
        });
    }
