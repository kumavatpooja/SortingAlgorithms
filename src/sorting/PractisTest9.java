 ...
 * @author home
 */
public class PractisTest9 extends javax.swing.JFrame {
     ...
     */
    public PractisTest9(int questionAnswered,int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Question No 9");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(102, 0, 255));
        jLabel3.setText("Running merge sort on an array of size n which is already sorted is-------");
    ...
    private void btnCheckanswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckanswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           if (jrbtn2.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is 0(nlogn)");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           new PractisTest10(testanswered,marks).setVisible(true);
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PractisTest9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PractisTest9(0,0).setVisible(true);
            }
        });
    }
