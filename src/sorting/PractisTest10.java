 ...
 * @author home
 */
public class PractisTest10 extends javax.swing.JFrame {
     ...
     */
    public PractisTest10(int questionAnswered,int marks) {
        initComponents();
    ...
    private void btnCheckanswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckanswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           if (jrbtn4.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is Shell sort");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
       //prevent goto next question without selecting ans answer
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           testanswered = testanswered + 10;
           //call for next question window with passing values
           new Result(testanswered,marks).setVisible(true);
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PractisTest10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PractisTest10(0,0).setVisible(true);
            }
        });
    }
