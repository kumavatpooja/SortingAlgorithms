 ...
 * @author home
 */
public class PractisTest3 extends javax.swing.JFrame {
     ...
     */
    public PractisTest3(int questionAnswered,int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jrbtn4.setText("dynamic programming");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(lblAnswerStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 396, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(220, 220, 220))
        );
    ...
    private void btnCheckanswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckanswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           if (jrbtn3.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is divide and conquer");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           new PractisTest4(testanswered,marks).setVisible(true);
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PractisTest3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PractisTest3(0,0).setVisible(true);
            }
        });
    }
