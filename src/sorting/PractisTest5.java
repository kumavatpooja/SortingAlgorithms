 ...
 * @author home
 */
public class PractisTest5 extends javax.swing.JFrame {
     ...
     */
    public PractisTest5(int questionAnswered,int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Quick sort is a space-optimaised version of --------------");
        ...
        jrbtn4.setText("Binary tree sort");
    ...
    private void btnCheckanswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckanswerActionPerformed
       ...
       if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           if (jrbtn4.isSelected()){
             ...
             lblAnswerStatus.setText("inCorrect - Answer is Binary tree sort");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!jrbtn1.isSelected() && !jrbtn2.isSelected() && !jrbtn3.isSelected() && !jrbtn4.isSelected() ){
           ...
           new PractisTest6(testanswered,marks).setVisible(true);
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PractisTest5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PractisTest5(0,0).setVisible(true);
            }
        });
    }
